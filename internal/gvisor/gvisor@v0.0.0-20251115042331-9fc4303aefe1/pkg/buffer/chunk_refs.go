...
// obj is used to customize logging. Note that we use a pointer to chunk so that
// we do not copy the entire object when passed as a format parameter.
var obj *chunk

// chunkRefs implements refs.RefCounter. It keeps a reference count using atomic
