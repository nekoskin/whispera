...
// obj is used to customize logging. Note that we use a pointer to PacketBuffer so that
// we do not copy the entire object when passed as a format parameter.
var obj *PacketBuffer

// packetBufferRefs implements refs.RefCounter. It keeps a reference count using atomic
