	...
	return &MessengerProfile{
		...
		Application: ApplicationProfile{
			...
			States: []ActivityState{
				...
				{
					Name:             "mini_program",
					PacketsPerSecond: Distribution{Type: "gaussian", Params: []float64{25.0, 10.0}},
				...
				},
				{
					...
					PacketSizes:      Distribution{Type: "uniform", Params: []float64{180, 320}},
			...
			Bursts: BurstProfile{
				...
				GroupReadBurst:     Distribution{Type: "pareto", Params: []float64{10, 2.5}},
		...
		Timing: TimingModel{
			...
			DailyPattern: DailyActivityPattern{
				HourlyActivity: [24]float64{
					0.25, 0.15, 0.08, 0.05, 0.03, 0.05,
					0.10, 0.30, 0.60, 0.80, 0.90, 0.95,
					1.0, 0.98, 0.95, 0.90, 0.88, 0.85,
					0.90, 0.95, 1.0, 0.95, 0.70, 0.45,
				},
				WeekendModifier: 1.1,
			...
			HumanNoise: HumanNoiseModel{
				ReadingTimePerChar:  80 * time.Millisecond,
		...
		Context: ContextProfile{
			DNS: DNSProfile{
				Servers:    []string{"119.29.29.29", "182.254.116.116"},
